...
<body class="container">
    ...
    <form action="" method="post" class="formfeedback"> <a href="" class="crossmark">&#x2716</a><br><br>
    ...
    <div class="top">
        ...
        <img src="../images/feedbackmatters.jpg" id="feedbackmatters" alt="" srcset="" title="Feedback Matters">
        <img src="../images/feedbackcartoon.png" id="feedbackcartoon" alt="" srcset="" title="Hi!!, user">
